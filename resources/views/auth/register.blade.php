...
@section('title', 'Register - Muxg Chat')
    ...
    <div class="max-w-md w-full space-y-8">
        <div class="text-center">
            ...
            <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                Join Muxg Chat and start messaging
            </p>
        </div>
            ...
            <form method="POST" action="{{ route('register.post') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <input 
                        ...
                        value="{{ old('email') }}" 
                        required
                        class="input @error('email') border-red-500 focus:ring-red-500 focus:border-red-500 @enderror"
